		...
		<div className={styles.clubCard} key={club.id}>
			...
			<div className={styles.btnWrapper}>
				{(club.user_id == loggedUser.id) ? <>
					<button className={styles.join} onClick={() => navigate('/editclub/' + club.id)}>Edit</button>
					<button className={styles.exit} club-id={club.id} onClick={deleteClub}>Delete</button>
				</> : <>
